                    ...
                    <div className="row">
                        <div className="col-3">
                            ...
                            <div className="filter-card mb-3">
                                ...
                                <div>
                                    <h5 className="sub-title">Availbility</h5>
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                    <div className="d-flex align-items-center gap-10">
                                        ...
                                        <select name="" id="" className="form-control form-select">
                                            ...
                                            <option value="best-selling" selected="slected">Best Selling</option>
                                    ...
                                    <div className="d-flex align-items-center gap-10">
                                        ...
                                        <div className="d-flex align-items-center grid gap-10">
                                            <img onClick={() => {setGrid(3);}} src="images/four.png" alt="grid" className="d-block img-fluid" />
                                            <img onClick={() => {setGrid(4);}} src="images/three1.svg" alt="grid" className="d-block img-fluid" />
                                            <img onClick={() => {setGrid(6);}} src="images/two.png" alt="grid" className="d-block img-fluid" />
